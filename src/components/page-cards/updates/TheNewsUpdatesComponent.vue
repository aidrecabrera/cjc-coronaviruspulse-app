        ...
        <div
          ...
          <div>
            <div class="grid overflow-hidden grid-cols-2 grid-rows-3 grid-flow-col gap-2">
              <div id="info" class="row-span-3 box bg-slate-500">1</div>
              <div id="imgcontainer" class="row-span-1 box bg-pink-700">2</div>
              <div id="imgcontainer" class="row-span-2 box bg-pink-700">3</div>
            </div>
          </div>
        </div>
