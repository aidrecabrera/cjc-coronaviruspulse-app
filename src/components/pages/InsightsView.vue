<template>
  <main>
    <div>
      <div>
        <div>JHU CSSE COVID-19 Dashboard</div>
        <p>The COVID-19 Dashboard is maintained by Center for Systems Science and Engineering (CSSE) from Johns Hopkins
          ...
          (JHU CSSE) and it is also supported by ESRI Living Atlas Team and the Johns Hopkins University Applied Physics
          Lab (JHU APL).</p>
      </div>
      ...
      <div>COVID-19 Dashboards from World Health Organization</div>
      <div>
      ...
      <div>
        ...
        <p>The WHO coronavirus (COVID-19) dashboard presents official daily counts of COVID-19 cases, deaths and vaccine
          utilisation reported by countries, territories and areas. Through this dashboard, we aim to provide a
          frequently updated data visualization, data dissemination and data exploration resource, while linking users
          to other useful and informative resources.

          Caution must be taken when interpreting all data presented, and differences between information products
          published by WHO, national public health authorities, and other sources using different inclusion criteria and
          different data cut-off times are to be expected. While steps are taken to ensure accuracy and reliability, all
          data are subject to continuous verification and change. All counts are subject to variations in case
          detection, definitions, laboratory testing, vaccination strategy, and reporting strategies. Other important
          considerations are highlighted under the respective Data Sources below.
          ...
          Data for Bonaire, Sint Eustatius and Saba have been disaggregated and displayed at the subnational level.</p>

        <p>Weekend updates: Starting 19 June 2021, daily counts of COVID-19 confirmed cases and deaths reported to WHO
          headquarters on Saturdays and Sundays will be updated on this dashboard on the following Monday. Furthermore,
          data from the Eastern Mediterranean Region are no long update on Fridays. Data will continue to be attributed
          to the day of initial reporting to avoid artificial spikes in case and death incidence. Given continued and
          increasing volatility in daily count data, we continue to encourage all users to prioritize weekly counts and
      ...
      <div>
        ...
        <p>From the 31 December 2019 to the 21 March 2020, WHO collected the numbers of confirmed COVID-19 cases and
          deaths through official communications under the International Health Regulations (IHR, 2005), complemented by
          monitoring the official ministries of health websites and social media accounts. Since 22 March 2020, global
          data are compiled through WHO region-specific dashboards (see links below), and/or aggregate count data
          reported to WHO headquarters daily.

          Counts primarily reflect laboratory-confirmed cases and deaths, based upon WHO case definitions; although some
          departures may exist due to local adaptations. Counts include both domestic and repatriated cases. Case
          detection, definitions, testing strategies, reporting practice, and lag times (e.g. time to case notification,
          and time to reporting of deaths) differ between countries, territories and areas. These factors, amongst
          others, influence the counts presented with variable under or overestimation of true case and death counts,
          and variable delays to reflecting these data at a global level.

          All data represent date of reporting as opposed to date of symptom onset. All data are subject to continuous
          verification and may change based on retrospective updates to accurately reflect trends, changes in country
          case definitions and/or reporting practices. Significant data errors detected or reported to WHO may be
          corrected at more frequent intervals.

          New case and death counts: Counts of new cases and deaths are calculated by subtracting previous cumulative
          total counts from the current count. These counts are updated incrementally throughout the day as more
          information becomes available. Daily new case and death counts are complete by 23:59 CET/CEST each day. Due to
          differences in reporting methods, cut-off times, retrospective data consolidation and reporting delays, the
          ...
          numbers of cases or deaths from their total counts, such data may reflect as negative numbers in the new cases
          / new deaths counts as appropriate. This will aid users in identifying when such adjustments occur. When
          additional details become available that allow the subtractions to be suitably apportioned to previous days,
          data will be updated accordingly.

          Current day counts, global epidemic curves and trends: Due to the incremental updates to the dashboard, global
          ...
          required to process and validate the incoming data, there is a delay between reporting to WHO and the update
          of the dashboard. To account for different time zones across WHO Regions and data transmission methods, and
          improve the timeliness of data availability, updates to the global dashboard are applied three times per day.

          Counts and corrections made after these times will be carried forward to the next reporting cycle for that
          specific region. Delayed reporting for any specific country, territory or area may result in pooled counts for
          multiple days being presented, with a retrospective update to counts on previous days to accurately reflect
      ...
      <div>
        ...
        <p>We aim to provide weekly updates on vaccine introduction and administration by countries, territories and
          areas. These data are pooled from numerous sources, including direct reports from Member States, WHO review of
          ...
          Total administered doses, people vaccinated with at least one dose, and people fully vaccinated are cumulative
          totals since the start of vaccination in the respective country, through the latest data update. Total
          administered doses refers to single doses, and may not equal the total number of people vaccinated, depending
          on the specific dose regime (individuals receive multiple doses). Total doses administered per 100 population
          may exceed 100, for example when over half of the population receives both required vaccine doses under a two
      ...
      <div>
        ...
        <ul>
          ...
          <li>
            Eurostat. “Demo_pjan” (population as of 1 January by country, year, age and gender; last updated by Eurostat
